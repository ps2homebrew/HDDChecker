...
After successful initialization, FSSK will create an fssk device, which will have the following I/O functions:
    open:
    ...
    ioctl2
        ...
        Codes:
            ...
            FSSK_IOCTL2_CMD_SIM             (7) = Runs a simulation. The partsDeleted status will indicate the number of partitions to be deleted, and the size of the partitions deleted will be returned.
